...
const btnAdd = document.getElementsByClassName("btn-danger");
...
function myfunction(){
    ...
    var urunler=["lassa","petsa","goodyear","honda","fıat","peugout","pirelli","michelin","bridgestone","continental","rangeover","audi","mercedes","symbol","seat","tofaş"];
    var sonuc=urunler.indexOf(s2);
    if(search==""){
        alert("Lütfen marka girin.Boş Bırakılamaz.")
    }
    else{
        if(sonuc>-1){
            alert("Bu Ürün Bulunmaktadır.");
        }
        else{
            alert("Malasef ki bu ürün BULUNMAMAKTADIR.");
        }
    }
}
